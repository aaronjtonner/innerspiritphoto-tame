      ...
      <Container>
        <Wrapper className="spacing">
          <Text className="spacing">
            ...
            <p className="accent">
              Getting butterflies before booking your first photography session
              is normal… whether it’s because you’re excited or nervous (or
              both!). We’ll meet you where you are and help you navigate through
