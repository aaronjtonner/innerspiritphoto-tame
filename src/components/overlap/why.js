  ...
  return (
    <Section className="spacing">
      <Container className="spacing">
        <h2 className="headline center">why we only do beauty photography</h2>
        <WrapperTextRight>
          <StaticImage
            className="img-left"
      ...
      <Container>
        <WrapperTextLeft>
          <TextBoxLeft className="spacing text-left">
            <p>
              <span className="headline">...</span>Something like: beauty
              photography.
            </p>
            <p>
            ...
            <p>
              That’s why at Inner Spirit, we strongly believe in photography as
              a self-discovery journey. It’s so much more than the photograph.
            </p>
