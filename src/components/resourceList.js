      ...
      <Container>
        <div className="spacing">
          <Article to="/contest">
            <StaticImage
              className="img"
              src="../images/resources/contest-img.jpg"
              alt="calgary gallery"
            />
            <div>
            ...
            <ButtonWrapper>
              <ButtonPrimary to="/contest">view contest &#x2192;</ButtonPrimary>
            </ButtonWrapper>
          </Article>
          <Article>
            <StaticImage
          ...
          <Article to="/portfolios/books">
            <StaticImage
              className="img"
              src="../images/resources/fb-group.jpg"
              alt="calgary  books portfolio"
            />
            <div>
          ...
          {/* <Article to="/portfolios/books">
            <StaticImage
              className="img"
              src="../images/resources/prep-guide.jpg"
              alt="calgary  books portfolio"
            />
            <div>
              ...
              <p>
                ...
                what to expect. Download our Preparation Guide. It
                is all you need.
              </p>
            </div>
            <ButtonWrapper>
