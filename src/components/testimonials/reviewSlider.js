...
const ReviewBox = props => {
  return (
    <ReviewWrapper className="spacing">
      <div>
        <StaticImage src="../../images/frill.jpg" alt="" />
        <FlexStars>
          <FaStar />
          <FaStar />
          <FaStar />
          ...
          <Slider className="slider" {...settings}>
            <ItemGrid>
              <StaticImage
                ...
                src="../../images/joy-review-tame.jpg"
                alt=""
              />
              <ReviewBox
                review="At first I resisted, saying it was extravagant and unnecessary, but the more I talked to Mark and saw his work I realized it was a fantastic opportunity. We shot a mix of poses and once I saw the completed album,  my confidence soared! I was a huge fan from that point on. Do this now for yourself or a loved one. You will never stop enjoying the results!"
                name="Joy B."
              />
            </ItemGrid>
            <ItemGrid>
              <StaticImage
                className="slider-img"
                src="../../images/kathy-b-tame-review.jpg"
                alt=""
              />
              <ReviewBox
            ...
            <ItemGrid>
              ...
              <ReviewBox
                className="review-box"
                review="Mark was instrumental in changing the view my wife had of herself after three kids.  His thoughtful input, witty charm and great photography skills made for a memorable makeover session.  She has gone from hiding behind baggy sweats to wearing the clothes of a confident woman!"
                name="Robin H."
              />
            </ItemGrid>
          </Slider>
