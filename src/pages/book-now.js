...
import BannerImg from "../images/banners/contact-banner-phone.jpg"
  ...
  return (
    <Layout>
      ...
      <FullImageTestimonial
        ...
        Mark was a way for me to get my divine femininity power back, and I needed that to move forward with my new single life.
        ...
        Mark captured my true essence — photography at Inner Spirit ignited my divine strength, and I now own my feminine strength."
        name="barb s."
        to="/experience"
